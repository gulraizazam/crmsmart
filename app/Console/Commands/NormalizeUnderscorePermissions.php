...
class NormalizeUnderscorePermissions extends Command
{
    ...
    private function extraChildren(): array
    {
        ...
        $treatments = [
            ['treatments_services', 'View treatments'],
            ['treatments_edit', 'Edit'],
            ['treatments_export', 'Export'],
            ['treatments_appointment_status', 'Update status'],
            ['treatments_invoice', 'Create invoice'],
            ['treatments_patient_card', 'Patient card'],
            ['treatments_invoice_display', 'View invoice'],
            ['treatments_edit_after_arrived', 'Edit after arrived'],
            ['treatments_destroy', 'Delete'],
            ['treatments_today', "Today's treatments"],
        ];
        $extras = [
            ...
            ['appointments_view', 'View details', 'appointments_manage'],
            ['appointments_services', 'Manage treatment records', 'treatments_manage'],
            ['can_edit_doctor', 'Change doctor after arrived', 'treatments_manage'],
            ['can_edit_schedule', 'Change schedule after arrived', 'treatments_manage'],
            ['can_edit_service', 'Change service after arrived', 'treatments_manage'],
            ['edit_after_arrived', 'Edit after arrived', 'appointments_manage'],
            ['update_consultation_doctor', 'Edit doctor after arrived', 'appointments_manage'],
            ['update_consultation_schedule', 'Edit schedule after arrived', 'appointments_manage'],
            ['update_consultation_service', 'Edit service after arrived', 'appointments_manage'],
