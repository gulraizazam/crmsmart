...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('sms_templates')
            ...
            ->update([
                'content' => 'Dear #patient_name#, your consultation at Smart Aesthetics is scheduled for #appointment_time#, today.
...
For any assistance, please communicate here.',
    ...
    public function down()
    {
        ...
        DB::table('sms_templates')
            ->where('slug', 'consultancy_whatsapp')
            ->update([
                'content' => 'Dear #patient_name#, your consultation at Smart Aesthetics is scheduled for #appointment_time#, today. We look forward to seeing you on time.
