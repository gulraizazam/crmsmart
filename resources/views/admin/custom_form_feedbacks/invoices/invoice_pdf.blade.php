...
<div class="invoice-pdf">
    ...
    <table>
        <tr>
            <td>
                <img class="logo" src="{{ asset('logoClarity.jpg') }}" class="img-responsive" alt="Clarity Aesthetic" style="height:70px;width:auto;"/>
                <p class="logo_caption">{{$location_info->address}}.</p>
                <p class="logo_caption logo_caption2">Phone. {{$location_info->fdo_phone}}  &nbsp; |  &nbsp; Email. {{$account->email}}  &nbsp; | &nbsp; https://clarityaesthetic.pk  &nbsp; | &nbsp; NTN. {{$location_info->ntn}} &nbsp; | &nbsp; STN. {{$location_info->stn}}</p>
            </td>
