...
<div class="modal-content disc-modal">
    ...
    <form id="modal_edit_discounts_form" method="post" action="">
        ...
        <div class="modal-body disc-modal-body scroll-y">
            <div class="d-flex flex-column scroll-y" id="kt_modal_discounts_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
