...
<head>
    <meta charset="utf-8" />
    <title>Smart Aesthetics — Treatment Invoice #{{$Invoiceinfo->id}}</title>
...
<div class="cinv-shell">
    ...
    <div class="cinv-head">
        <div class="cinv-brand">
            ...
            <div class="cinv-brand-sub">Aesthetic Care &middot; Treatment</div>
        </div>
        <div class="cinv-doc-type">
            <div class="cinv-title">Treatment Invoice</div>
    ...
    <div class="cinv-info-wrap">
        <table class="cinv-info-grid">
            ...
            <tr>
                <td colspan="2">
                    <div class="cinv-info-label">Attending Doctor</div>
    ...
    <div class="cinv-summary">
        <div class="cinv-summary-title">Treatment Service</div>
    ...
    <div class="cinv-note">
        ...
        Thank you for choosing Smart Aesthetics for your treatment.
    </div>
    ...
    <div class="cinv-signatures">
        ...
        <div class="cinv-sig-block">
            <div class="cinv-sig-line">Doctor Signature</div>
